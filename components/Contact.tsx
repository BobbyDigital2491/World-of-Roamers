...
const Contact = () => {
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        <div>
            <p className="font-medium text-yellow-400 dark:text-yellow-400">Contact us</p>

            <h1 className="mt-2 text-2xl font-semibold text-white md:text-3xl dark:text-white">Chat to our friendly team</h1>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    <span className="inline-block p-3 text-yellow-500 rounded-full bg-gray-800 dark:bg-gray-800">
                    ...
                    <p className="mt-2 text-sm text-yellow-400 dark:text-yellow-400">pieces2piece@gmail.com</p>
                </div>
                ...
                <div>
                    ...
                    <h2 className="mt-4 text-base font-medium text-white dark:text-white">Live chat</h2>
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                    <p className="mt-2 text-sm text-yellow-400 dark:text-yellow-400">Start new chat</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-yellow-400 dark:text-yellow-400">1109 Belleview St., Suite 101
                    Columbia, SC 29201</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-yellow-400 dark:text-yellow-400"> Main Office: 803-846-2499</p>
                    <p className="mt-2 text-sm text-yellow-400 dark:text-yellow-400"> Dr Gantt Personal: <br/>803-250-5198 </p>
            ...
            <div className="p-4 py-6 rounded-lg bg-gray-800 dark:bg-gray-800 md:p-8">
                <form>
                    ...
                    <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-yellow-400 rounded-lg hover:bg-yellow-200 active:bg-yellow-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                        Send message
                    </button>
                </form>
            </div>
