...
const Review = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
    <h2 className="text-xl text-yellow-400 font-bold sm:text-2xl">Customer Reviews</h2>
    ...
    <div className="mt-4 flex items-center gap-4">
      ...
      <div>
        ...
        <p className="mt-0.5 text-xs text-gray-300">Based on 48 reviews</p>
      </div>
    </div>
    ...
    <div className="mt-8 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-2">
      <blockquote>
        <header className="sm:flex sm:items-center sm:gap-4">
          ...
          <p className="mt-2 text-yellow-400 font-medium sm:mt-0">Dr Gantt needs an award!</p>
        </header>

        <p className="mt-2 text-gray-300">
          I was looking for help with my anxiety and found P2P. Through working with Dr.Gantt I was able to learn
          way how to deal with my anxiety when it came up at tghe worst times. I also have a personal link to the organization in 
          troubling times. I would definitly refer this organiztion for others with anxiety problems.
        </p>

        <footer className="mt-4">
          <p className="text-xs text-gray-500">Shawn Perez - 31st March, 2023</p>
        </footer>
      </blockquote>
      ...
      <blockquote>
        <header className="sm:flex sm:items-center sm:gap-4">
          ...
          <p className="mt-2 text-yellow-400 font-medium sm:mt-0">Amazing Womans group</p>
        </header>

        <p className="mt-2 text-gray-300">
          Mental health in the black community is something that isnt spoken about often. I decided to give
          therapy a try, and was suprised to find out how many women from different cultures go through the same
          things. The womans group allows us all to get a better understanding of ourselves and work through our 
          problems as a group. 
        </p>

        <footer className="mt-4">
          <p className="text-xs text-gray-500">Gabriela Brown - 12th January, 2023</p>
        </footer>
      </blockquote>
